import svgPaths from "./svg-kvz1riwfdy";
...
export default function AppContent() {
  return (
    <div className="bg-[rgba(36,99,162,0.45)] relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="AppContent">
      <Section />
      <Container1 />
      <Container183 />
    </div>
